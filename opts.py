...
def model_opts(parser):
    ...
    # group.add_argument('-data', default='/home/xwshi/easymoses_workspace2/reinforcement_learning/nmt/nmpt_baseline_nhf_vocab_v6/corpus/nmpt_bpe', help='path to dataset, now json file')
    ...
    group.add_argument('-position_encoding', action='store_true',
                       ...
                       """)
    # group.add_argument('-local_position_encoding', action='store_true',
    #                    help="""Use a sin to mark relative words positions.
    #                    Necessary for non-RNN style models.
    #                    """)
...
def train_opts(parser):
    ...
    # group.add_argument('-data', required=False,help="""Path prefix to the ".train.pt" and ".valid.pt" file path from preprocess.py""")
...
def translate_opts(parser):
    ...
    group.add_argument("-G_path", default="")
